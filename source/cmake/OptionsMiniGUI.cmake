...
XGUIPRO_OPTION_DEFINE(USE_ANIMATION "Whether to enable animation." PUBLIC OFF)
XGUIPRO_OPTION_DEFINE(USE_SCREEN_CAST "Whether to enable screen cast." PUBLIC OFF)
XGUIPRO_OPTION_DEFINE(ENABLE_DNSSD_BROWSING "Whether to enable dnssd browsing." PUBLIC OFF)
...
XGUIPRO_OPTION_DEFAULT_PORT_VALUE(USE_SCREEN_CAST PUBLIC ON)
...
if (USE_SCREEN_CAST)
    set(ENABLE_DNSSD_BROWSING_DEFAULT OFF)
else ()
    set(ENABLE_DNSSD_BROWSING_DEFAULT ON)
endif ()

XGUIPRO_OPTION_DEFAULT_PORT_VALUE(ENABLE_DNSSD_BROWSING PUBLIC ${ENABLE_DNSSD_BROWSING_DEFAULT})
