...
- [WebKit2GTK 2.28.0+](https://webkitgtk.org): Use the package `libwebkit2gtk-4.0-dev` or `libwebkit2gtk-4.1-dev` on popular Linux distributions; Use the package [webkit2-gtk-devel](https://ports.macports.org/port/webkit2-gtk-devel/) on macOS.
- [PurC 0.9.26+](https://github.com/HVML/PurC): the HVML interpreter for C language. This repository also includes two libraries to maintain a DOM tree, lay out and stylize the DOM elements by using CSS. xGUI Pro needs these libraries.
...
1. The HVML interpterter PurC 0.9.26+.
...
- Sept. 2025: Version 0.9.26. (PurC 0.9.26+)
- June 2025: Version 0.9.24. (PurC 0.9.24+)
