...
- [WebKitGTK 2.34.0+]: Use the package `libwebkit2gtk-4.0-dev` or `libwebkit2gtk-4.1-dev` on popular Linux distributions. For more information, please refer to <https://webkitgtk.org/>.
